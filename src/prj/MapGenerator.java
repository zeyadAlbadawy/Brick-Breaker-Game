...
public class MapGenerator {
	...
	public MapGenerator(int row, int col) {
		...
		for (int i = 0; i < map.length; i++) {
			for (int j = 0; j < map[0].length; j++) {
				...
				// If you do not want to draw any particular brick put the value of the array
				// elements equals zero
			}
		}
		BrickWidth = 540 / col;
		BrickHeight = 150 / row; // recommended values for the the dimensions of the brick
	}
	...
	// big slip will be drawn when this function called where there is an array
	// value of 1
